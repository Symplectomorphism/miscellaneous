...
#include "rngs.h"
#include "rvgs.h"
#include "crossing_narm.h"




void crossing_narm(double *M, int *n, int *m, double *MU, double *MUsig, int *rmax, double *MUsigd, int *weight, int *e)
{ 
 ...
 */  
 ...
 #############################################################
 */ 
 crops(M, *n, *m, MU, delta, o_init, *weight, *e);
 /*
 #############################################################
 ...
 */ 
 for(r = 0; r < *rmax; r++)
 {
  ...
  #############################################################
  */    
  crops(M_r, *n, *m, MU_r, delta, o_init, *weight, *e);
  for(i = 0; i < *m; i++)
  {
   for(j = 0; j < *m; j++)
   {
...
#############################################################################################
*/
void crops(double MM[], int nn, int mm, double mu[], double delta, int o_init[], int w, int ee)
{ 
 double a[nn], g[nn];
 int o[nn], s[nn];
 int i, j1, j2;
 ...
 */
  ...
  */  
   ...
   */
   ...
   #############################################################
   */
   mu[(j2 * mm)+(ee-1)] = cross( g, nn, delta, w);
  }
 ...
 */
  ...
  */  
   ...
   */
   ...
   #############################################################
   */
   mu[((ee-1) * mm)+j1] = cross( g, nn, delta, w);

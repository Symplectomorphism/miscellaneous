...
\hypersetup{
    ...
    pdftitle={Data-Driven Passivity-Based Control of Underactuated Mechanical Systems via Interconnection and Damping Assignment},    % title
    pdfauthor={Wankun Sirichotiyakul, Aykut C. Satici},     % author

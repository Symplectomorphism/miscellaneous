...
% de\u{g}erler i\c{c}in de ge\c{c}erlidir. Kule kural{\i}n{\i}~\ref{thm:tower}
...
\vspace{-3mm}
\paragraph{Computation of the term $\mathbb{E}\left[ C_0 \mid s_1 = C2
 \right]$.} 
%  Benzer \c{s}ekilde~\eqref{eq:tower1}'inci denklemin sa\u{g}
